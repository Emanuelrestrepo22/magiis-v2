...
| ID     | Item                                                                                  | Archivos / artefactos                                                   | Criterio aceptacion                                               | Estado                                                  |
| ------ | ------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------- | ------------------------------------------------------- |
| FW-005 | refactor: segmentar specs por suite + dominio                                         | `tests/specs/{regression,exploratory}/<dominio>/`                       | Workflows verdes; tags preservados; `release-v2.0.2/` migrado     | 🔵 pendiente                                            |
...
| FW-007 | feat: locators compartidos extraidos a `tests/locators/<portal>/<screen>.locators.ts` | `tests/locators/carrier-v2/`                                            | Reuso real entre 2+ POMs sin regresion                            | 🔵 pendiente (requiere auditoria previa de duplicacion) |
