...
test.describe('@P1 @functional @migration Sprint 2 - Release V2.0.2', () => {
  test('MX-5559 Map Viewer - heading + mapa Leaflet + filtros drivers visibles', async ({ page }) => {
  ...
  test('MX-5554 CC Con Afiliados - heading + tabla', async ({ page }) => {
    ...
    test.info().annotations.push({ type: 'route_v2', description: '/carrier/#/affiliate/checking-account' });
  ...
  test('MX-5569 Documentacion Vencida - heading + tabla', async ({ page }) => {
    ...
    test.info().annotations.push({ type: 'route_v2', description: '/carrier/#/reports/documentation' });
