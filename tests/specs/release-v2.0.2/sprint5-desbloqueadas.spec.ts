...
test.describe('@P1 @functional @migration Sprint 5 - Release V2.0.2 desbloqueadas', () => {
  test('MX-5531 Travel unpaid list - URL real /reports/unpaid-travels-list', async ({ page }) => {
    ...
    test.info().annotations.push({ type: 'route_v2', description: '/carrier/#/reports/unpaid-travels-list' });
    test.info().annotations.push({
      type: 'note',
      description: 'URL desbloqueada vs lo que estaba bajo /travel/ - el componente vive en /reports/.'
    });
  ...
  test('MX-5553 Viajes por Segmentos - URL real /reports/segments-travels', async ({ page }) => {
    ...
    test.info().annotations.push({ type: 'route_v2', description: '/carrier/#/reports/segments-travels' });
