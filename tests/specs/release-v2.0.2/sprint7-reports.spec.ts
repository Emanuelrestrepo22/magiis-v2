...
test.describe('@P2 @functional @migration Sprint 7 - reportes adicionales release/v2.0.4', () => {
  test('Travels List Report - heading + tabla', async ({ page }) => {
    ...
    test.info().annotations.push({ type: 'route_v2', description: '/carrier/#/reports/travels-list' });
  ...
  test('Drivers Ranking Report - heading + tabla', async ({ page }) => {
    test.info().annotations.push({ type: 'jira', description: 'MX-5711' });
    test.info().annotations.push({ type: 'route_v2', description: '/carrier/#/reports/ranking-drivers' });
  ...
  test('Cost Center Report - heading + tabla', async ({ page }) => {
    test.info().annotations.push({ type: 'jira', description: 'MX-5711' });
    test.info().annotations.push({ type: 'route_v2', description: '/carrier/#/reports/cost-center-report' });
  ...
  test('Corporate Services Type Report - heading + tabla', async ({ page }) => {
    test.info().annotations.push({ type: 'jira', description: 'MX-5711' });
    test.info().annotations.push({ type: 'route_v2', description: '/carrier/#/reports/corporate-services-type' });
  ...
  test('Individual CA Travels Report - heading + tabla', async ({ page }) => {
    test.info().annotations.push({ type: 'jira', description: 'MX-5711' });
    test.info().annotations.push({ type: 'route_v2', description: '/carrier/#/reports/individual-ca-travels' });
  ...
  test('Customers Ranking Report - heading + tabla', async ({ page }) => {
    test.info().annotations.push({ type: 'jira', description: 'MX-5711' });
    test.info().annotations.push({ type: 'route_v2', description: '/carrier/#/reports/ranking-clients' });
  ...
  test('Vehicles Ranking Report - heading + tabla', async ({ page }) => {
    test.info().annotations.push({ type: 'jira', description: 'MX-5711' });
    test.info().annotations.push({ type: 'route_v2', description: '/carrier/#/reports/ranking-vehicles' });
