...
// Audit WCAG 2.1 AA con axe-core sobre Payment Movements. Soft audit (no falla CI).
...
test.describe('@a11y @P2 @migration MX-5568 Payment Movements - audit WCAG 2.1 AA', () => {
