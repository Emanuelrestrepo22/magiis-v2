...
// Audit WCAG 2.1 AA con axe-core sobre Settings / Other Costs. Soft audit (no falla CI).
...
test.describe('@a11y @P3 @migration MX-5575 Settings Other Costs - audit WCAG 2.1 AA', () => {
