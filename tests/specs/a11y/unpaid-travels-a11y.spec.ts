...
// Audit WCAG 2.1 AA con axe-core sobre Unpaid Trips Report. Soft audit (no falla CI).
...
test.describe('@a11y @P2 @migration MX-5531 Unpaid Trips Report - audit WCAG 2.1 AA', () => {
