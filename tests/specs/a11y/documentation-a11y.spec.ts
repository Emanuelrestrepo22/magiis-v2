...
// Audit WCAG 2.1 AA con axe-core sobre Expired Documentation. Soft audit (no falla CI).
...
test.describe('@a11y @P2 @migration MX-5569 Expired Documentation - audit WCAG 2.1 AA', () => {
