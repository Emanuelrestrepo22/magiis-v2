...
// Audit WCAG 2.1 AA con axe-core sobre Taxes & Fees Report. Soft audit (no falla CI).
...
test.describe('@a11y @P2 @migration MX-5566 Taxes & Fees Report - audit WCAG 2.1 AA', () => {
