...
const RELEASE_V2_0_2_PAGES = [
  ...
  { mx: 'MX-5565', name: 'Reporte Card Transactions', url: '/carrier/#/reports/transaction-tracking' },
  ...
  { mx: 'MX-5571', name: 'Reporte Agency Commissions', url: '/carrier/#/reports/agency-commissions' },
